...
function updateOrderCartAction()
{
    ...
    if (isset($_SESSION['cart']) && array_key_exists($idProd, $_SESSION['cart']['buy'])) {
        ...
        $totalPrice =$cartItem['price_product'] * $numOrder;
...
function checkOutAction()
{
    ...
    $listProvince1 = getLocationByLevel(2);
    // $listDistrict = getLocationByLevel(2);
    // $listStreet = getLocationByLevel(3);
                                    ...
                                    <div class='content-info'>
                                        ...
                                        <ul>
                                            ...
                                            <li style='padding: 5px 0;'>
                                                ...
                                                <span>dieuhiendo0704@gmail.com</span>
                                            </li>
                                            <li style='padding: 5px 0;'>
                                                <span>Thông về đơn hàng xin vui lòng liên hệ: 0425543843 </span>
                                            </li>
                                        </ul>
                                    </div>
