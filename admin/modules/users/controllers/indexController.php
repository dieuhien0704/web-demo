...
<?php
    ...
    function registerAction() {
        ...
        if(isset($_POST['btn_register'])) {
            ...
            if(empty($error)){
                if(!user_exists($username,$email)){// kt user name va email da ton tai trong he thong chua
                    ...
                    $subject = "Xác thực tài khoảng tại dieuhien.vn";
                    ...
                    color: #474747;'>
                    smart xin kinh chào Anh/Chi {$fullname}
                    </h3>
                    ...
                    display: inline-block;'>Click vào đây để kích hoạt tài khoảng</a>
                        <p>Mọi thắt mắt xin liên hệ tại địa chỉ email: <span>dieuhiendo07042002@gmail.com</span></p>
        ...
        if(isset($_POST['btn_getpass'])){
            ...
            if(empty($error)){
                if(check_email($email)) {
                    ...
                    $email_receiver = $email;
                    $subject = "Xác thực tài khoảng tại dieuhiendo.vn";
                    $content = "<div style='width: 70%;
                    min-width: 300px;
                    padding: 30px;
                    margin: 0 auto;
                    ...
                    display: inline-block;
                    color: #474747;'>
                    ISMART  xin kinh chào Anh/Chi {$user_getpass['fullname']}
                    </h3>
                    <div style='padding: 20px;
                    font-size: 15px;
                    color: #746a6a;'>
